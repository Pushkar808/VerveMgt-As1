        ...
        <div className='w-full h-full'>
            ...
            <Contentgrid classCss="bg-blue-300 pb-5">
                ...
                <section className={`md:col-span-3`}>
                    ...
                    <ul ref={ref} className={`list-disc p-4 'animate__animated animate__fadeInDown' : ''}`}>
                        <li className={` ${inView ? 'animate__animated animate__delay-1s animate__lightSpeedInRight' : ''}`}>    Gain Knowledge and Insights from Top Industry Leaders and Experts from across the globe</li>
                        <li className={` ${inView ? 'animate__animated animate__delay-2s animate__lightSpeedInRight' : ''}`}>	Network with Industry Peers in a solution-oriented environment</li>
                        <li className={` ${inView ? 'animate__animated animate__delay-3s animate__lightSpeedInRight' : ''}`}>	Discuss Significant Partnerships and Collaborations with Industry leaders</li>
                        <li className={` ${inView ? 'animate__animated animate__delay-4s animate__lightSpeedInRight' : ''}`}>	Deep Dive into Insights derived from real-time case studies</li>
                        <li className={` ${inView ? 'animate__animated animate__delay-5s animate__lightSpeedInRight' : ''}`}>	Build Industry Ecosystem Collaboration to address latest challenges</li>
                    </ul>
                </section >
            </Contentgrid >
