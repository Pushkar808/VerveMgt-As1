    ...
    return (
        <footer class="bg-white">
            <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                >
                    <div className='w-96 md:p-0 p-6'>
                        <strong class="text-xl text-white sm:text-xl "> Are you interested to sponsor our event? </strong>
                        <p>To find out more about the ROI-driven sponsorship and exhibition opportunities</p>
                        <p>
                            <strong>
                                Contact us now at:
                            </strong><span className='text-indigo-200'>+971 4 243 4677</span>
                        </p>
                        <p>
                            <strong> Email: </strong><span className='text-indigo-200'>info@verve-management.com</span>
                        </p>
                    </div>
                    <a
                ...
                <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <ul class="mt-8 space-y-4 text-sm">
                            <li>
                                <div class="" href="/"> <i class="px-2 text-xl fa-solid fa-location-dot"></i> 1702 & 1706 , Mazaya Business Avenue BB2, Al Thanya Fifth, Jumeirah Lake Towers, Dubai, UAE </div>
                            </li>

                            <li>
                                <div class="" href="/"> <i class="px-2 text-xl fa-solid fa-phone"></i>+971 4 243 4677/88</div>
                            </li>
                            <li>
                                <div class="" href="/"> <i class="px-2 text-xl fa-solid fa-envelope"></i>
                                    info@verve-management.com</div>
                            </li>
